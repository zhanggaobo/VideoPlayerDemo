...
public class VDVideoExtListeners {
    ...
    public void setOnVDVideoPlayerChangeListener(OnVDVideoPlayerChangeListener l) {
        mOnVDVideoPlayerChangeListener = new WeakReference<OnVDVideoPlayerChangeListener>(l);
    }

    public void setOnVDVideoInsertADEndListener(OnVDVideoInsertADEndListener l) {
        mOnVDVideoInsertADEndListener = new WeakReference<OnVDVideoInsertADEndListener>(l);
    }

    public void setOnVDVideoPreparedListener(OnVDVideoPreparedListener l) {
        mOnVDVideoPreparedListener = new WeakReference<OnVDVideoPreparedListener>(l);
    }
    ...
    public void setFrameADListener(OnVDVideoFrameADListener l) {
        mFrameADListener = new WeakReference<OnVDVideoFrameADListener>(l);
    }
    ...
    public void setInsertADListener(OnVDVideoInsertADListener l) {
        mInsertADListener = new WeakReference<OnVDVideoInsertADListener>(l);
    }
    ...
    public void setPlaylistListener(OnVDVideoPlaylistListener l) {
        mPlaylistListener = new WeakReference<OnVDVideoPlaylistListener>(l);
    }
    ...
    public void setOnVDPlayerTypeSwitchListener(OnVDPlayerTypeSwitchListener l) {
        mOnVDPlayerTypeSwitchListener = new WeakReference<OnVDPlayerTypeSwitchListener>(l);
    }
    ...
    public void setOnVDVideoCompletionListener(OnVDVideoCompletionListener l) {
        mOnVDVideoCompletionListener = new WeakReference<OnVDVideoCompletionListener>(l);
    }
    ...
    public void setOnVDVideoErrorListener(OnVDVideoErrorListener l) {
        mOnVDVideoErrorListener = new WeakReference<OnVDVideoErrorListener>(l);
    }
    ...
    public void setOnVDVideoInfoListener(OnVDVideoInfoListener l) {
        mOnVDVideoInfoListener = new WeakReference<OnVDVideoInfoListener>(l);
    }
